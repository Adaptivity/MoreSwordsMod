...
{
	static MinecraftServer minecraft = MinecraftServer.getServer();
	...
	public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
	{
		...
		if(Player.getCurrentEquippedItem() != null && Player.getCurrentEquippedItem().itemID == MoreSwordsMod.items.awakenedBlazeSword.shiftedIndex)
		{
			//put the part that would remove fall damage here
		}
	}
